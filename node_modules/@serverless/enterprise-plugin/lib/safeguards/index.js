...
function _runPolicies() {
  _runPolicies = _asyncToGenerator(function* (ctx) {
    ...
    if (ctx.sls.logDeprecation) {
      ctx.sls.logDeprecation('DASHBOARD_SAFEGUARDS', ['Safeguards support has been moved to the @serverless/safeguards-plugin external plugin and will be removed from the core with next major release.', '', 'Please visit https://github.com/serverless/safeguards-plugin/ to migrate your safeguards to the new plugin.', 'You may also disable safeguards by setting "custom.enterprise.safeguards.isDisabled: true" in service config', ''].join(`\n${' '.repeat('Serverless: '.length)}`));
    }
