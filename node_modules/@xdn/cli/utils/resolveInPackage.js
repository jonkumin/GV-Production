...
module.exports = function resolveInPackage(pkg, ...file) {
  ...
  let path = resolvePackagePath(pkg) || resolvePackagePath(pkg, process.cwd()); // ^^ the second call to resolvePackagePath above is needed to resolve from packages
  // that are linked with lerna (e.g. the examples in the xdn repo).
